...
module RackRabbit
  ...
  class Config
    ...
    has_option :adapter,     :default => lambda{ require 'rack-rabbit/adapter/bunny'; RackRabbit::Adapter::Bunny }
    ...
    def validate
      ...
      raise ArgumentError, "invalid rabbitMQ adapter" unless [:connect, :disconnect, :subscribe, :publish].all?{|method| adapter.new.respond_to?(method)}
    end
